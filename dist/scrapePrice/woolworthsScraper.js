...
exports.scrapeWoolworthsPrice = scrapeWoolworthsPrice;
const puppeteer_1 = __importDefault(require("puppeteer"));
async function scrapeWoolworthsPrice(url) {
    if (!url) {
    ...
    try {
        ...
        if (!priceDollarsElement) {
            throw new Error(`Price dollars element not found on the page for Woolworths.`);
        }
        ...
        await browser.close();
        console.error(`Error scraping price from URL: ${url} for Woolworths`, error);
        throw error;
    }
}
